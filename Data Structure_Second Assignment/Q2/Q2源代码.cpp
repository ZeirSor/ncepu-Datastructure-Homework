...
int main()
{
	...
	printf(------------------------集合极其运算------------------------n);
	printf(	1. 初始化创建空集合；n);
	printf(	2. 初始化后输入集合元素；n);
	printf(	3. 输出全部集合元素；n);
	printf(	4. 插入一个数到集合指定位置；n);
	printf(	5. 按值删除集合中的元素；n);
	printf(	6. 按值在集合中进行查找；n);
	printf(	7. 清空集合；n);
	printf(	8. 进行集合运算；n);
	printf(	9. 求两个集合的交集；n);
	printf(	10.求两个集合的并集；n);
	printf(	11.求两个集合的差集；n);
	printf(	0. 退出。n);
